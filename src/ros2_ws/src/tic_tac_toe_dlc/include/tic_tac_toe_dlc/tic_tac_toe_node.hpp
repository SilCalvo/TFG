...
private:
    ...
    Point3D get_point_relative_to_camera(int u, int v, double depth, const sensor_msgs::msg::CameraInfo& info);
    Point3D get_point_relative_to_robot_tf(const Point3D& p_cam, const std::string& camera_frame, const std::string& robot_frame);
